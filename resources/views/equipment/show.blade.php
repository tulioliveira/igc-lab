				...
				<div class="four wide column">
					{!! Form::open(['method'=>'DELETE', 'action'=>['EquipmentController@destroy', $equipment->id], 'class'=>'ui delete form']) !!}
						...
						<div class="ui buttons right floated">
							<button class="ui animated fade button negative" tabindex="0" type="submit" data-content="Remover o equipamento do sistema" data-position="left center" id="deleteButton">
